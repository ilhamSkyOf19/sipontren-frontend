...
const BoxInputText: FC<Props> = ({
  ...
  return (
    <div className="w-full flex flex-col justify-start items-start">
      ...
      <div
        className={clsx(
          "w-full px-4 py-1 h-11 border border-primary-brown rounded-lg mt-2 focus-within:shadow-[0_4px_6px_0_rgba(0,0,0,0.1)] transition-all duration-300 ease-in-out focus-within:-translate-y-1",
